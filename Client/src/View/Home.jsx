        ...
        <div className='ContainerHome h-screen bg-white flex flex-wrap justify-center items-center'>
            <div className='Home bg-white rounded-xl'>
                <header className='w-full flex justify-evenly items-center '>
                    ...
                    {mostrarComponente && <ComponenteMostrable toggle={toggleComponente} />}
                ...
                <main className='xl:grid xl:grid-cols-2'>
                    <div className='flex flex-col items-center my-5 flex-wrap'>
                        ...
                        <Link to="/Registrate" className='Button w-40 p-4 text-center rounded-full text-gray-700 mb-10'>Registrate</Link>
...
function ComponenteMostrable({toggle}) {
    return (
        <nav className='absolute  w-4/5 bg-gray-500 text-white rounded-lg text-left pl-5 border border-black'>
            <div className='w-full flex justify-end pr-5 my-2'>
                <button onClick={toggle}><Icons icon={faX} css='text-3xl mx-2 xl:hidden' />
                </button>
            </div>
            <ul className=''>
