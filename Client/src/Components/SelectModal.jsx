                ...
                <nav className='mx-10'>
                    <ul>
                        <li className='flex items-center mb-8 cursor-pointer'>
                            ...
                            <Link to="/Registrate/typeUser/Turista" className="pl-8 text-xl font-normal">Turista</Link>
                        </li>
                        <li  className='flex items-center mb-8 cursor-pointer'>
                            <img src={Guide} alt="No found" className='w-1/3' />
                            <Link to="/Registrate/typeUser/Guia" className="pl-8 text-xl font-normal">Guía</Link>
                        </li>
                        <li  className='flex items-center mb-8 cursor-pointer'>
                            <img src={Mensajero} alt="No found" className='w-1/4' />
                            <Link to="/Registrate/typeUser/Proveedor" className="pl-14 text-xl font-normal">Proveedor</Link>
                        </li>
                    </ul>
                </nav>
            </main>
